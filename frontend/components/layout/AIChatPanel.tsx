    ...
    <>
      ...
      <div className="relative border-t border-gray-200 p-3 flex-shrink-0">
        ...
        <button
          ...
          aria-label="맨 아래로 이동"
          className={`absolute -top-12 left-1/2 -translate-x-1/2 z-10 flex h-9 w-9 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-600 shadow-md hover:bg-gray-50 hover:text-primary-600 transition-opacity duration-200 ${
