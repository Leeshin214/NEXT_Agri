...
export default function BuyerPartnersPage() {
  ...
  const handleStartChat = async (partner: Partner) => {
    ...
    try {
      ...
      console.error('[buyer/partners] 채팅방 생성 실패:', e);
    } finally {
  ...
  const handleDeletePartner = async (partner: Partner) => {
    ...
    try {
      ...
      console.error('[buyer/partners] delete failed:', e);
  ...
  // 구매자: /buyer/browse 가 ?seller_id 쿼리를 받아 해당 판매자 상품만 표시
  const showCreateOrderAction = true;
