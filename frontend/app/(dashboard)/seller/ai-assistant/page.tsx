...
import { sellerQuickPrompts } from '@/constants/aiPrompts';
...
export default function SellerAIAssistantPage() {
  ...
  return (
    <div>
      <PageHeader title="AI 업무 도우미" description="AI가 판매 업무를 도와드립니다" />

      {/* 빠른 프롬프트 */}
      <div className="mb-6 grid grid-cols-2 gap-3 lg:grid-cols-4">
        {sellerQuickPrompts.map((qp) => (
          <button
            key={qp.type}
      ...
      <div className="flex gap-2">
        <input
          ...
          placeholder="AI에게 질문하세요 (예: 이번 달 매출 추이 분석해줘)"
          disabled={isStreaming}
