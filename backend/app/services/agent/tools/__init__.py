...
- negotiation   (8): get_pending_counter_offers, get_pending_delivery_date_changes, submit/accept/reject_counter_offer, submit/accept/reject_delivery_date_change
...
그룹 분류:
- "inventory_order" : product 6 + order 6 + partner 7 + subscription 6 + negotiation 8 + user 4 = 37
- "calendar"        : 4
- "chat"            : 3
"""
